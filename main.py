...
# ax.plot_trisurf(X, Y, Z, cmap='terrain', edgecolors='white', alpha=0.5)

# # If we dont want to see points keep this commented out
# # ax.scatter(X, Y, Z, c='red', marker='^')

# ax.set_title('3D Surface Plot using Lidar Data')
